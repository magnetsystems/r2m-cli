...
class StringHelperSpec extends Specification {
  ...
  static String content2 = 'pc -qf -n ${projectName}  -o ${outputDir}  -DgroupId=com.magnet -Dpackage=com.magnet.connect.baseline.project1 -Dversion=1.1.0\n' +
      'api-add simple -q'
  static String expandedContent2 = "pc -qf -n name  -o C:\\Program\\ Files\\MABProjects\\name  -DgroupId=com.magnet -Dpackage=com.magnet.connect.baseline.project1 -Dversion=1.1.0\n" +
      "api-add simple -q"
