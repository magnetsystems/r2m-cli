...
public final class ConfigLexicon {
  ...
  */
  ...
  public static final String DEFAULT_PROJECT_VERSION_VALUE = "1.1.0-RC1";
  ...
  public static final String LINKEDIN_CONTROLLER_VERSION = "1.1.0-RC1";
  ...
  public static final String FACEBOOK_CONTROLLER_VERSION = "1.1.0-RC1";
   ...
   */
  public static final String SALESFORCE_CONTROLLER_VERSION = "1.1.0-RC1";
  /**
